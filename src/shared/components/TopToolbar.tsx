...
const TopToolbar: React.FC<TopToolbarProps> = ({
  ...
  return (
    <div className="h-16 bg-gray-900 border-b border-gray-700 flex items-center justify-between px-6 relative z-20 shadow-md flex-shrink-0">
      ...
      <div className="flex flex-col items-center flex-1 max-w-md mx-auto">
        <label className="text-[10px] text-blue-400 uppercase font-bold tracking-wider mb-1 flex items-center gap-1.5">
        ...
        <div className="relative w-full">
          <select
            ...
            className="w-full bg-gray-800 border border-gray-600 text-white text-sm rounded-md px-3 py-2 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 hover:bg-gray-700 cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-not-allowed appearance-none text-center"
          >
            {styles.map(s => (
